...
*** secretName__으로 인증서 자동 생성_
	...
	kubectl.kubernetes.io/last-applied-configuration: |  {"apiVersion":"networking.k8s.io/v1beta1","kind":"Ingress","metadata":{"annotations":{"kubernetes.io/ingress.class":"nginx"},"name":"ingress-smartwork","namespace":"smartwork-dev"},"spec":{"rules":[{"host":"sm-dev.moimstone.com","http":{"paths":[{"backend":{"serviceName":"conference-service","servicePort":4020},"path":"/conference(/|$)(.*)"},{"backend":{"serviceName":"vendor-service","servicePort":4030},"path":"/vendor(/|$)(.*)"},{"backend":{"serviceName":"project-service","servicePort":4040},"path":"/project(/|$)(.*)"}]}}]}}
